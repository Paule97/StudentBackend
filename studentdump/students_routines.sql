...
--
/*!50003 DROP PROCEDURE IF EXISTS `gradesAddUpdate` */;
...
/*!50003 DROP PROCEDURE IF EXISTS `Students2Add` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Students2Add`(
IN _students_id INT,
IN _students_name varchar(45),
IN _students_number int
)
BEGIN
	IF ISNULL(_students_id) THEN
		INSERT INTO students2 (students_name, students_number)
        VALUES (_students_name, _students_number);
